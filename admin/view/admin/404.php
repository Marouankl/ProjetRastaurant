...
<?= require_once('C:/wamp64/www/projetPHP/admin/foot_header/header.php');?>
                    ...
                    <div class="carousel-container">
                        <div class="carousel-content">
                            ...
                            <div>
                                ...
                                <a href="#book-a-table" class="btn-book animate__animated animate__fadeInUp scrollto">Réserver un table </a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?= require_once('C:/wamp64/www/projetPHP/admin/foot_header/footer.php');?>
